...
class CryptoStorage {
    ...
    get(key) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const value = yield decryptValue(cryptoValue, cryptoKey, nonce);
                return decode(value);
            }
            catch (error) {
    ...
    set(key, value) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const cryptoKey = yield deriveCryptKey(baseKey, salt, encryptIterations);
            const [cryptoValue, nonce] = yield encryptValue(value, cryptoKey);
...
const verifySalt = (storePromise, storeName, salt) => __awaiter(void 0, void 0, void 0, function* () {
    const [hash, store] = yield all([generateHash('salt'), storePromise]);
...
const persistSalt = (saltHash, store, storeName, currentSalt) => __awaiter(void 0, void 0, void 0, function* () {
    const salt = currentSalt !== null && currentSalt !== void 0 ? currentSalt : generateSalt();
    yield store.put(storeName, salt, saltHash);
    return salt;
});

export { CryptoStorage };
//# sourceMappingURL=web-crypto-storage.es2015.js.map
